...
export default function ToolsPage() {
  ...
  return (
    <>
      <Head>
        <title>Atlas Tools — Atlas Printers</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <HamburgerMenu isOpen={sidebarOpen} onClick={() => setSidebarOpen(!sidebarOpen)} />
      <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} currentPage="tools" />
      ...
      >
        ...
        >
          ...
          <p style={{ margin: '8px 0 0 0', fontSize: '13px', opacity: 0.7 }}>
            Tools for extending and customizing Atlas functionality.
          </p>
        </div>
      </div>
    </>
